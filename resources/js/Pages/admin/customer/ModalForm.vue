...
<template>
    <VDialog :showModal="openDialog" :title="updateAction ? 'Update customer' : 'Create customer'" @opened="openForm" @closed="closeForm" size="xl">
        ...
        <template v-slot:content>
            <div class="grid grid-cols-2 gap-3">
                ...
                <div class="col-span-2">
                    <VInput placeholder="Insert Email" label="Email" :required="true" v-model="form.email" :errorMessage="formError.email"
