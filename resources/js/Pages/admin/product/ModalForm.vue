    ...
    <VDialog :showModal="openDialog" :title="updateAction ? 'Update Product' : 'Create Product'" @opened="openForm" @closed="closeForm" size="xl">
        ...
        <template v-slot:content>
            <div class="grid grid-cols-2 gap-3">
                ...
                <VInput placeholder="Insert Content" label="Stock" :required="true" v-model="form.content" :errorMessage="formError.content"
                    @update:modelValue="formError.content = ''" type="number"/>
                <div class="col-span-2">
